                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title" id="staticBackdropLabel">Ingresar Datos del Curso</h1>
                                                                ...
                                                                <form action="consultas/recibirDatos.php" method="post">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-6 col-sm-6 col-md-6 col-lg-6 mb-2">
                                                                            <select class="form-select" name="gradoMateria" id="gradoMateria" aria-label="Default select example">
                                                                        ...
                                                                        <div class="col-6 col-sm-6 col-md-6 col-lg-6 mb-2">
                                                                            <select class="form-select" name="seccionMateria" id="seccionMateria" aria-label="Default select example">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="container-fluid">
                                                                <form action="consultas/recibirDatos.php" method="post">
                                                                    <div class="row">
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                                                            <input type="number" class="form-control" name="idMaterias" id="idMaterias" placeholder="Id">
                                                                        </div>
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                        ...
                                        <table class="table table-dark table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col-2">Nombre del curso</th>
                                                    <th scope="col-2">Grado</th>
                                                    <th scope="col-1">Sección</th>
                                                    <th scope="col-2">Estudiantes</th>
