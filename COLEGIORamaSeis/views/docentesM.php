                ...
                <div class="container-fluid tablaEstudiantes">
                    <div class="col-12">
                        ...
                        <section class="modalEliminar"><!--Modal para eliminar estudiantes-->
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-2">
                                        <div class="ContenidoModal">
                                            <div class="modal fade" id="EliminarDocente" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title" id="staticBackdropLabel">Eliminar Datos del Docente</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="container-fluid">
                                                                <form action="../controllers/docentes/docentesDelete.php" method="post">
                                                                    <div class="row">
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-4">
                                                                            <input type="text" class="form-control" name="idEliminarDocentes" id="idEliminarDocentes" placeholder="Id del docente a eliminar">
                                                                        </div>
                                                                    </div>
                                                                    <!--La finalización del form esta abajo-->
                                                            </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                                                <div class="container-fluid">
                                                                    <div class="row">
                                                                        <div class="d-grid col-6 col-sm-6 col-md-6 col-lg-6">
                                                                            <button type="submit" class="btn btn-success" name="EliminarDocente">Eliminar Datos</button>
                                                                        </div>
                                                                        <div class="d-grid col-6 col-sm-6 col-md-6 col-lg-6">
                                                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar Acción</button>
                                                                        </div>
                        ...
                        <section class="Tablas">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-0 px-5">
                                        <table class="table table-dark table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                include_once "../controllers/docentes/docentesRead.php";

                                                if ($validacionDocentesR) {

                                                    while ($mostrarDocentes = $validacionDocentesR->fetch_array()) {
                                                ?>
                                                        <tr>
                                                            <th scope="col" style="color: #2a9d8f;"><?php echo $mostrarDocentes['id_Docente']; ?></th>
                                                            <th scope="col" style="color: #a4ac86;"><?php echo $mostrarDocentes['Nombres']; ?></th>
                                                            <th scope="col" style="color: #a4ac86;"><?php echo $mostrarDocentes['Apellidos']; ?></th>
                                                            <th scope="col" style="color: #a4ac86;"><?php echo $mostrarDocentes['Dpi']; ?></th>
                                                            <th scope="col" style="color: #a4ac86;"><?php echo $mostrarDocentes['Genero']; ?></th>
                                                            <th scope="col" style="color: #a4ac86;"><?php echo $mostrarDocentes['Correo']; ?></th>
                                                            <th scope="col" style="color: #a4ac86;"><?php echo $mostrarDocentes['Telefono']; ?></th>
                                                            <th scope="col" style="color: #a4ac86;"><?php echo $mostrarDocentes['Informacion']; ?></th>
                                                            <th scope="col" style="color: #a4ac86;">
                                                                ...
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#EliminarDocente" data-bs-backdrop="#staticBackdrop"><i class="fa-solid fa-trash"></i></a>
                                                            </th>
                                                        </tr>
                                                <?php
                                                    }
