...
if (isset($_POST['registrarDocente'])) {
    ...
    if (
        ...
        $consultaDocentesC = "INSERT INTO `docentes`(`id_Docente`, `Nombres`, `Apellidos`, `Dpi`, `Genero`, `Correo`, `Telefono`, `Informacion`) 
        ...
        $validacionDocentesC = mysqli_query($conexion, $consultaDocentesC);

        if ($validacionDocentesC) {
