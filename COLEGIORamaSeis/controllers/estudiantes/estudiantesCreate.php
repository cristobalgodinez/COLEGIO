...
if (isset($_POST['registrarEstudiante'])) {
    ...
    if (
        ...
        $consultaEstudiantesC = "INSERT INTO `estudiantes`(`id_Estudiante`, `Nombres`, `Apellidos`, `Grado`, `Seccion`, `Cui`, `Genero`, `Nom_Encargado`, `Telefono`) 
        ...
        $validacionEstudiantesC = mysqli_query($conexion, $consultaEstudiantesC);

        if ($validacionEstudiantesC) {
