                                                                ...
                                                                <form action="consultas/recibirDatos.php" method="post">
                                                                    <div class="row">
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                                                            <input type="number" class="form-control" name="idDocentes" id="idDocentes" placeholder="Id" required>
                                                                        </div>
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                                                        ...
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                                                            <input type="email" class="form-control" name="emailDocentes" id="emailDocentes" placeholder="Correo" required>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2 mt-2">
                                                                            <textarea class="form-control" name="infoAdicDocentes" id="infoAdicDocentes" placeholder="Descripción"></textarea>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="container-fluid">
                                                                <form action="consultas/recibirDatos.php" method="post">
                                                                    <div class="row">
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-4">
                                                                            <input type="number" class="form-control" name="EditaridDocentes" id="EditaridDocentes" placeholder="Id del docente a editar">
                                                                        </div>
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                                                            <input type="number" class="form-control" name="idDocentes" id="idDocentes" placeholder="Id">
                                                                        </div>
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                                                            <input type="text" class="form-control" name="nombresDocentes" id="nombresDocentes" placeholder="Nombres">
                                                                        </div>
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                                                            <input type="text" class="form-control" name="apellidosDocentes" id="apellidosDocentes" placeholder="Apellidos">
                                                                        </div>
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                                                            <input type="number" class="form-control" name="dpiDocentes" id="dpiDocentes" placeholder="Dpi">
                                                                        </div>
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                                                            <input type="text" class="form-control" name="generoDocentes" id="generoDocentes" placeholder="Género">
                                                                        </div>
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                                                            <input type="email" class="form-control" name="emailDocentes" id="emailDocentes" placeholder="Correo">
                                                                        </div>
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-4">
                                                                            <input type="number" class="form-control" name="telefonoDocentes" id="telefonoDocentes" placeholder="Teléfono">
                                                                        </div>
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2 mt-2">
                                                                            <textarea class="form-control" name="infoAdicDocentes" id="infoAdicDocentes" placeholder="Descripción"></textarea>
                                                                        </div>
