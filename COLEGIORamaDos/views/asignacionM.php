                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable modal-xl">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="container-fluid">
                                                                <form action="../controllers/asignar/asignarCreate.php" method="post">
                                                                    <div class="row">
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
                                                                            <select class="form-select" name="asigarEstudiantes" id="asignarEstudiantes" aria-label="Default select example" required>
                                                                        ...
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
                                                                            <select class="form-select" name="asignarMateria" id="asignarMateria" aria-label="Default select example" required>
                        ...
                        <section class="modalEditar"><!--Modal para editar estudiantes-->
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-2">
                                        <div class="ContenidoModal">
                                            <div class="modal fade" id="EditarAsignarEst" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title" id="staticBackdropLabel">Editar Datos de la Asignación</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="container-fluid">
                                                                <form action="../controllers/asignar/asignarUpdate.php" method="post">
                                                                    <div class="row">
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
                                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-4">
                                                                                <input type="text" class="form-control" name="nombreasigarEst" id="nombreasigarEst" placeholder="Ingrese el nombre del estudiante a modificar" required>
                                                                            </div>
                                                                            <select class="form-select" name="EditarasigarEst" id="EditarasignarEst" aria-label="Default select example" required>
                                                                                <!-- <option selected>Nombre del estudiante</option> -->
                                                                                <option value="">Nombre del estudiante</option>
                                                                                <option value="primero">Primero</option>
                                                                                <option value="segundo">Segundo</option>
                                                                        ...
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
                                                                            <select class="form-select" name="EditarasignarMat" id="EditarasignarMat" aria-label="Default select example" required>
                                                                                <!-- <option selected>Materia</option> -->
                                                                                <option value="">Materia</option>
                                                                                <option value="seccionA">A</option>
                                                                                <option value="seccionB">B</option>
                        ...
                        <section class="modalEliminar"><!--Modal para eliminar estudiantes-->
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-2">
                                                    <div class="ContenidoModal">
                                                        <div class="modal fade" id="EliminarAsignarUsu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm">
                                                                <div class="modal-content" style="background-color: #1f2937;">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="container-fluid">
                                                                            <form action="../controllers/asignar/asignarDelete.php" method="post">
                                                                                <div class="row">
                                                                                    <div class="text-center">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                                                            <div class="container-fluid">
                                                                                <div class="row">
                                                                                    <div class="d-grid col-6 col-sm-6 col-md-6 col-lg-6">
                                                                                        <button type="submit" class="btn btn-success" name="eliminarAsignarUsu">Eliminar</button>
                                                                                    </div>
                                                                                    <div class="d-grid col-6 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <table class="table table-dark table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th scope="col"></th>
                                                    <th scope="col">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#EditarAsignarEst" data-bs-backdrop="#staticBackdrop"><i class=" fa-solid fa-pencil"></i></a>
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#EliminarAsignarUsu" data-bs-backdrop="#staticBackdrop"><i class="fa-solid fa-trash"></i></a>
                                                    </th>
                                                </tr>
                                                <!--CONTENIDO DE PRUEBA-->
                                                <tr>
