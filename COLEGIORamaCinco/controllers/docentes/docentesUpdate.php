...
if (isset($_POST['editarDocente'])) {
    ...
    if (
        ...
        $consultaDocentesU = "UPDATE `docentes` SET `id_Docente`='$idDocentes',`Nombres`='$nombresDocentes',`Apellidos`='$apellidosDocentes',`Dpi`='$dpiDocentes',
        ...
        $validacionDocentesU = mysqli_query($conexion, $consultaDocentesU);

        if ($validacionDocentesU) {
